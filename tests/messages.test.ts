...
describe('RuntimeMessageType', () => {
  it('keeps critical command/event constants stable', () => {
    ...
    expect(RuntimeMessageType.TEST_GET_CAPTURE_FIXTURE).toBe('TEST_GET_CAPTURE_FIXTURE');
    expect(RuntimeMessageType.TEST_GET_ORPHAN_FIXTURE).toBe('TEST_GET_ORPHAN_FIXTURE');
    expect(RuntimeMessageType.TEST_SET_CAPTURE_FIXTURE).toBe('TEST_SET_CAPTURE_FIXTURE');
    expect(RuntimeMessageType.TEST_SET_ORPHAN_FIXTURE).toBe('TEST_SET_ORPHAN_FIXTURE');
    expect(RuntimeMessageType.TEST_PREPARE_START).toBe('TEST_PREPARE_START');
    expect(RuntimeMessageType.TEST_START_RECORDING).toBe('TEST_START_RECORDING');
    expect(RuntimeMessageType.TEST_STOP_RECORDING).toBe('TEST_STOP_RECORDING');
    expect(RuntimeMessageType.TEST_REFRESH_ORPHANS).toBe('TEST_REFRESH_ORPHANS');
    expect(RuntimeMessageType.TEST_RECOVER_ORPHAN).toBe('TEST_RECOVER_ORPHAN');
    expect(RuntimeMessageType.TEST_DISCARD_ORPHAN).toBe('TEST_DISCARD_ORPHAN');
    ...
    expect(RuntimeMessageType.OFFSCREEN_TEST_SEED_ORPHANS).toBe('OFFSCREEN_TEST_SEED_ORPHANS');
